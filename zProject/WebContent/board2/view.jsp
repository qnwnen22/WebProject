...
$(function() {
	...
	$("#btnReply").click(function(){
		document.form1.action="${path}/board2_servlet/reply.do";
		document.form1.submit();
	});
	
	$("#btnWrite").click(function(){
		location.href="${path}/board2/write.jsp";
	});
...
function comment_add(){
	...
	$.ajax({
		type: "post",
		url: "${path}/board2_servlet/comment_add.do",
		data: param,
		success: function(){
			$("#writer").val("");
			$("#content").val("");
...
function comment_list(){
	$.ajax({
		type: "post",
		url: "${path}/board2_servlet/commentList.do",
		data: "num=${dto.num}",
						...
						<tr>
							<td colspan="4">
								...
								<input type="button" value="글쓰기" id="btnWrite">
			      				...
			      				<form style="display: inline;" method="post" action="<%=context %>/board2_servlet/edit.do" id="form1" name="form1">
									<input type="hidden" name="num" value="${dto.num}">
									<input type="hidden" name="subject" value="${dto.subject}">
								...
								<form style="display: inline;" method="post" action="<%=context %>/board2_servlet/up.do" id="form2" name="form2">
									<input type="hidden" name="num" value="${dto.num}">
