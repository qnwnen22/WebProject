...
$(function() {
	...
	$("#btnList").click(function() {
		location.href="${path}/board3_servlet/list.do";
	});
	...
	$("#btnReply").click(function(){
		document.form1.action="${path}/board3_servlet/reply.do";
...
function comment_add(){
	...
	$.ajax({
		type: "post",
		url: "${path}/board3_servlet/comment_add.do",
		data: param,
		success: function(){
			$("#writer").val("");
			$("#content").val("");
...
function comment_list(){
	$.ajax({
		type: "post",
		url: "${path}/board3_servlet/commentList.do",
		data: "num=${dto.num}",
						...
						<tr>
							<td colspan="4">
								...
								<input type="button" value="글쓰기" id="btnWrite">
			      				...
			      				<form style="display: inline;" method="post" action="<%=context %>/board3_servlet/edit.do" id="form1" name="form1">
									<input type="hidden" name="num" value="${dto.num}">
									<input type="hidden" name="subject" value="${dto.subject}">
								...
								<form style="display: inline;" method="post" action="<%=context %>/board3_servlet/up.do" id="form2" name="form2">
									<input type="hidden" name="num" value="${dto.num}">
