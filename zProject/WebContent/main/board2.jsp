<%@page import="board2.dto.Board2DTO"%>
...
<%
List<Board2DTO> list=(List<Board2DTO>)request.getAttribute("list");
%>
...
function list(page) {
	location.href="${path}/board2_servlet/list.do?curPage="+page;
}
</script>
</head>
<body>
	...
	<section class="section">
		...
		<div class="col-sm-8 text-left"> 
			<div class="article-content">
				...
				<form action="${path}/board2_servlet/search.do" method="post" name="form1">
				...
				<table class="table">
					...
					<%for(Board2DTO dto : list){ %>
					<tr> 
						<td style="text-align: center; font-size: 12px;"><%=dto.getNum() %></td>
						<td style="font-weight: bold">
							<a href="${path}/board2_servlet/view.do?num=<%=dto.getNum() %>" id="click">
							<%=dto.getSubject() %></a>
