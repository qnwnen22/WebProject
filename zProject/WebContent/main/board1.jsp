<%@page import="board1.dto.Board1DTO"%>
...
<%
List<Board1DTO> list=(List<Board1DTO>)request.getAttribute("list");
%>
...
function list(page) {
	location.href="${path}/board1_servlet/list.do?curPage="+page;
}
</script>
</head>
<body>
				...
				<table class="table">
					...
					<tr> 
						...
						<td style="font-weight: bold">
							<a href="${path}/board1_servlet/view.do?num=<%=dto.getNum() %>" id="click">
							<%=dto.getSubject() %></a>
