<%@page import="board0.dto.Board0DTO"%>
...
List<Board0DTO> list=(List<Board0DTO>)map.get("list");
Board0DTO dto1 = new Board0DTO();
%>
...
function list(page) {
	location.href="${path}/board0_servlet/list.do?curPage="+page;
}
</script>
</head>
<body>
	...
	<section class="section">
		...
		<div class="col-sm-8 text-left"> 
			<div class="article-content">
				...
				<form action="${path}/board0_servlet/search.do" method="post" name="form1">
				...
				<table class="table">
					...
					<%for(Board0DTO dto : list){ %>
					<tr> 
						<td style="text-align: center; font-size: 12px;"><%=dto.getNum() %></td>
						<td style="font-weight: bold">
							<a href="${path}/board0_servlet/view.do?num=<%=dto.getNum() %>" id="click">
							<%=dto.getSubject() %></a>
